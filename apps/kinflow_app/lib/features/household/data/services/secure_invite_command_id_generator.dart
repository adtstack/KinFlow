...
final class SecureInviteCommandIdGenerator implements InviteCommandIdGenerator {
  SecureInviteCommandIdGenerator({Random? random})
  ...
  InviteCommandId generate() {
    ...
    final String uuid =
        ...
        '${hex.substring(16, 20)}-'
        '${hex.substring(20)}';
    final InviteCommandId? id = InviteCommandId.tryParse(uuid);
    if (id == null) {
      throw StateError('Secure invite command UUID generation failed.');
    }
    return id;
  }
}
