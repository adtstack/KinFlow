...
final class SecureDataExportCommandIdGenerator
    implements DataExportCommandIdGenerator {
  SecureDataExportCommandIdGenerator({Random? random})
  ...
  DataExportCommandId generate() {
    ...
    final String value =
        ...
        '${hex.substring(16, 20)}-'
        '${hex.substring(20)}';
    final DataExportCommandId? id = DataExportCommandId.tryParse(value);
    if (id == null) {
