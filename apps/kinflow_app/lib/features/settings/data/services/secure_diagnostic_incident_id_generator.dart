...
final class SecureDiagnosticIncidentIdGenerator
    implements DiagnosticIncidentIdGenerator {
  SecureDiagnosticIncidentIdGenerator({Random? random})
  ...
  DiagnosticIncidentId generate() {
    ...
    final String value =
        ...
        '${hex.substring(16, 20)}-'
        '${hex.substring(20)}';
    final DiagnosticIncidentId? id = DiagnosticIncidentId.tryParse(value);
    if (id == null) {
