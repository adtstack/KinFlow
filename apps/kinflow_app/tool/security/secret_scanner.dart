...
final class SecretScanner {
  ...
  static final List<_SecretRule> _rules = <_SecretRule>[
    ...
    _SecretRule(
      ...
      RegExp(
        r'''\b(?:APPLE_APP_STORE_API_PRIVATE_KEY|DATA_EXPORT_SIGNING_KEY|FCM_SERVER_CREDENTIAL|GOOGLE_CLIENT_SECRET|GOOGLE_PLAY_SERVICE_ACCOUNT_JSON|INTERNAL_JOB_AUTH_SECRET|INVITE_TOKEN_HMAC_KEY|KINFLOW_BILLING_RECONCILIATION_WORKER_SECRET|KINFLOW_DATA_EXPORT_WORKER_SECRET|KINFLOW_FIREBASE_SERVICE_ACCOUNT_JSON|KINFLOW_HOUSEHOLD_PRIVACY_WORKER_SECRET|KINFLOW_NOTIFICATION_PUSH_WORKER_SECRET|KINFLOW_NOTIFICATION_TOKEN_DECRYPTION_KEYS|KINFLOW_NOTIFICATION_TOKEN_ENCRYPTION_KEY|KINFLOW_NOTIFICATION_WORKER_SECRET|KINFLOW_REVENUECAT_ENTITLEMENT_ID|KINFLOW_REVENUECAT_SECRET_API_KEY|KINFLOW_REVENUECAT_WEBHOOK_AUTHORIZATION|KINFLOW_REVENUECAT_WEBHOOK_SIGNING_SECRET|REVENUECAT_SECRET_API_KEY|REVENUECAT_WEBHOOK_SECRET|SENTRY_AUTH_TOKEN|SIGNING_KEYSTORE_PASSWORD|SUPABASE_DB_PASSWORD|SUPABASE_DB_URL|SUPABASE_JWT_SECRET|SUPABASE_SERVICE_ROLE_KEY)\s*[:=]\s*["']?[^\s"']+''',
        caseSensitive: false,
      ),
